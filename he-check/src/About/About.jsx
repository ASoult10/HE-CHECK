  ...
  return (
    <div className="about">
      ...
      <div className="about-links-section">
        ...
        <p>Se puede consultar más información sobre el autor y acceder al código fuente del proyecto en los siguientes enlaces:</p>
        <div className='about-link'>
          <img className="about-link-img" src={GitHubLogo} alt="GitHub Logo" />
          <p><a href="https://github.com/ASoult10/HE-CHECK" target="_blank" rel="noopener noreferrer">Repositorio en GitHub</a></p>
        </div>
        <div className='about-link'>
          <img className="about-link-img" src={LinkedInLogo} alt="LinkedIn Logo" />
